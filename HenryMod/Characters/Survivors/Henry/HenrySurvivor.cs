...
namespace HenryMod.Survivors.Henry
{
    public class HenrySurvivor : SurvivorBase<HenrySurvivor>
    {
        ...
        public override string assetBundleName => "thepenguinassets"; //if you do not change this, you are giving permission to deprecate the mod

        //the name of the prefab we will create. conventionally ending in "Body". must be unique
        public override string bodyName => "PenguinBody"; //if you do not change this, you get the point by now

        //name of the ai master for vengeance and goobo. must be unique
        public override string masterName => "PenguinMonsterMaster"; //if you do not

        //the names of the prefabs you set up in unity that we will use to build your character
        public override string modelPrefabName => "mdlPenguin";
        public override string displayPrefabName => "PenguinDisplay";
